...
export LD_LIBRARY_PATH=$TRAVIS_BUILD_DIR/deps/share/:$LD_LIBRARY_PATH:/usr/local/lib
export LD_RUN_PATH=$TRAVIS_BUILD_DIR/deps/share/:$LD_RUN_PATH:/usr/local/lib
