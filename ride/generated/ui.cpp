...
SettingsEnviromentPanel::SettingsEnviromentPanel( wxWindow* parent, wxWindowID id, const wxPoint& pos, const wxSize& size, long style ) : wxPanel( parent, id, pos, size, style )
{
	...
	m_button32 = new wxButton( this, wxID_ANY, wxT("..."), wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT );
	...
	m_button33 = new wxButton( this, wxID_ANY, wxT("..."), wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT );
	...
	m_button34 = new wxButton( this, wxID_ANY, wxT("..."), wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT );
	...
	m_button35 = new wxButton( this, wxID_ANY, wxT("..."), wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT );
...
SettingsEditorPanel::SettingsEditorPanel( wxWindow* parent, wxWindowID id, const wxPoint& pos, const wxSize& size, long style ) : wxPanel( parent, id, pos, size, style )
{
	...
	uiTabIndents = new wxCheckBox( m_panel28, wxID_ANY, wxT("Tab indents"), wxDefaultPosition, wxDefaultSize, 0 );
	bSizer37->Add( uiTabIndents, 0, wxALL, 5 );
	
	uiBackspaceUnindents = new wxCheckBox( m_panel28, wxID_ANY, wxT("Bacspace unindents"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	sbSizer27 = new wxStaticBoxSizer( new wxStaticBox( m_panel26, wxID_ANY, wxT("Automatic insert") ), wxVERTICAL );
	...
	sbSizer28 = new wxStaticBoxSizer( new wxStaticBox( m_panel26, wxID_ANY, wxT("Indent") ), wxVERTICAL );
	...
	sbSizer29 = new wxStaticBoxSizer( new wxStaticBox( m_panel11, wxID_ANY, wxT("Current line") ), wxVERTICAL );
	...
	sbSizer30 = new wxStaticBoxSizer( new wxStaticBox( m_panel11, wxID_ANY, wxT("Selection") ), wxVERTICAL );
