...
int Style::x_margin() const { return x_margin_; }
int Style::y_margin() const { return y_margin_; }

void Style::set_x_margin(int x) { x_margin_ = x; }
void Style::set_y_margin(int y) { y_margin_ = y; }

int Style::row_spacing() const { return row_spacing_; }
int Style::col_spacing() const { return col_spacing_; }

void Style::set_row_spacing(int spacing) { row_spacing_ = spacing; }
void Style::set_col_spacing(int spacing) { col_spacing_ = spacing; }

int Style::item_maxwidth() const { return item_maxwidth_; }
int Style::item_maxheight() const { return item_maxheight_; }

void Style::set_item_maxwidth(int max) { item_maxwidth_ = max; }
void Style::set_item_maxheight(int max) { item_maxheight_ = max; }

int Style::dlg_main_border() const { return dlg_main_border_; }
int Style::dlg_item_border() const { return dlg_item_border_; }
