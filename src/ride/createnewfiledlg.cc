...
const wxString CreateNewFileDlg::GetFilePath() const
{
	...
	{
	case -1:
	case REPLACE_SPACE_NOT: break;
	case REPLACE_SPACE_WITH_NONE: file_name.Replace(" ", ""); break;
	case REPLACE_SPACE_WITH_UNDERSCORE: file_name.Replace(" ", "_"); break;
	case REPLACE_SPACE_WITH_DASH: file_name.Replace(" ", "-"); break;
