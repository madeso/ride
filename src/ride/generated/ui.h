...
protected:
	...
	virtual void OnChangeLineEnding(wxCommandEvent& event)
	{
		event.Skip();
	}

	virtual void OnChangeEncoding(wxCommandEvent& event)
	{
		event.Skip();
	}
...
public:
	...
	FileProperties(
		...
		const wxString& title = wxT("File properties"),
		const wxPoint& pos = wxDefaultPosition,
		const wxSize& size = wxSize(455, 197),
...
public:
	...
	CreateNewProject(
		wxWindow* parent,
		wxWindowID id = wxID_ANY,
		const wxString& title = wxT("Create new project"),
		const wxPoint& pos = wxDefaultPosition,
		const wxSize& size = wxSize(540, 349),
		long style = wxDEFAULT_DIALOG_STYLE | wxRESIZE_BORDER
	);
	~CreateNewProject();
};
...
protected:
	...
	virtual void OnComboChanged(wxCommandEvent& event)
	{
		event.Skip();
	}

	virtual void OnCheckChanged(wxCommandEvent& event)
	{
		event.Skip();
	}
...
public:
	...
	CreateNewFile(
		wxWindow* parent,
		wxWindowID id = wxID_ANY,
		const wxString& title = wxT("Create new file..."),
		const wxPoint& pos = wxDefaultPosition,
		const wxSize& size = wxSize(548, 351),
		long style = wxDEFAULT_DIALOG_STYLE | wxRESIZE_BORDER
	);
	~CreateNewFile();
};
...
public:
	...
	DeleteFolder(
		wxWindow* parent,
		wxWindowID id = wxID_ANY,
		const wxString& title = wxT("Delete folder?"),
		const wxPoint& pos = wxDefaultPosition,
...
protected:
	...
	virtual void OnContextSensitive(wxCommandEvent& event)
	{
		event.Skip();
	}
...
public:
	...
	QuickOpen(
		wxWindow* parent,
		wxWindowID id = wxID_ANY,
		const wxString& title = wxT("Open file in project..."),
		const wxPoint& pos = wxDefaultPosition,
		const wxSize& size = wxSize(616, 394),
		long style = wxDEFAULT_DIALOG_STYLE | wxRESIZE_BORDER
	);
	~QuickOpen();
};
...
public:
	...
	Find(
		wxWindow* parent,
		wxWindowID id = wxID_ANY,
		const wxString& title = wxT("Find..."),
		const wxPoint& pos = wxDefaultPosition,
		const wxSize& size = wxSize(326, 492),
		long style = wxDEFAULT_DIALOG_STYLE | wxRESIZE_BORDER
	);
	~Find();
};
...
protected:
	...
	virtual void OnTabWdithChanged(wxCommandEvent& event)
	{
		event.Skip();
	}

	virtual void OnEditorUseTabsClicked(wxCommandEvent& event)
	{
		event.Skip();
	}

	virtual void OnBuildConfiguration(wxCommandEvent& event)
	{
		event.Skip();
	}

	virtual void OnBuildConfigurationModify(wxCommandEvent& event)
	{
		event.Skip();
	}

	virtual void OnBuildCheckbox(wxCommandEvent& event)
	{
		event.Skip();
	}

	virtual void OnBuildText(wxCommandEvent& event)
	{
		event.Skip();
	}

	virtual void OnBuildTargetHelp(wxCommandEvent& event)
	{
		event.Skip();
	}

	virtual void OnBuildCustomArgHelp(wxCommandEvent& event)
	{
		event.Skip();
	}

	virtual void OnBuildFeatureAdd(wxCommandEvent& event)
	{
		event.Skip();
	}

	virtual void OnBuildFeatureEdit(wxCommandEvent& event)
	{
		event.Skip();
	}

	virtual void OnBuildFeatureRemove(wxCommandEvent& event)
	{
		event.Skip();
	}

	virtual void OnBuildFeatureUp(wxCommandEvent& event)
	{
		event.Skip();
	}

	virtual void OnBuildFeatureDown(wxCommandEvent& event)
	{
		event.Skip();
	}

	virtual void OnRunConfiguration(wxCommandEvent& event)
	{
		event.Skip();
	}

	virtual void OnRunConfigurationModify(wxCommandEvent& event)
	{
		event.Skip();
	}

	virtual void OnRunText(wxCommandEvent& event)
	{
		event.Skip();
	}

	virtual void OnRunApplication(wxCommandEvent& event)
	{
		event.Skip();
	}

	virtual void OnRunArguments(wxCommandEvent& event)
	{
		event.Skip();
	}

	virtual void OnRunFolder(wxCommandEvent& event)
	{
		event.Skip();
	}

	virtual void OnCmdBeforeLaunch(wxCommandEvent& event)
	{
		event.Skip();
	}

	virtual void OnRunCheck(wxCommandEvent& event)
	{
		event.Skip();
	}
...
public:
	...
	ProjectSettings(
		wxWindow* parent,
		wxWindowID id = wxID_ANY,
		const wxString& title = wxT("Project settings"),
		const wxPoint& pos = wxDefaultPosition,
		const wxSize& size = wxSize(666, 535),
		long style = wxDEFAULT_DIALOG_STYLE | wxRESIZE_BORDER
	);
	~ProjectSettings();
};
...
public:
	...
	Configurations(
		wxWindow* parent,
		wxWindowID id = wxID_ANY,
		const wxString& title = wxT("Configurations"),
		const wxPoint& pos = wxDefaultPosition,
		const wxSize& size = wxSize(463, 349),
		long style = wxDEFAULT_DIALOG_STYLE
	);
	~Configurations();
};
...
protected:
	...
	virtual void OnFolder(wxCommandEvent& event)
	{
		event.Skip();
	}

	virtual void OnCustomDoubleClick(wxCommandEvent& event)
	{
		event.Skip();
	}
...
public:
	...
	VariableEditor(
		...
		const wxPoint& pos = wxDefaultPosition,
		const wxSize& size = wxSize(434, 250),
		long style = wxDEFAULT_DIALOG_STYLE | wxRESIZE_BORDER
	);
	~VariableEditor();
};
...
protected:
	...
	// Virtual event handlers, overide them in your derived class
	virtual void OnSelectedStyleChanged(wxCommandEvent& event)
	{
		event.Skip();
	}

	virtual void OnStyleCheckChanged(wxCommandEvent& event)
	{
		event.Skip();
	}

	virtual void OnOnlyFixedSysChanged(wxCommandEvent& event)
	{
		event.Skip();
	}

	virtual void OnStyleFontChanged(wxCommandEvent& event)
	{
		event.Skip();
	}
	...
	virtual void OnStyleTextChanged(wxCommandEvent& event)
	{
		event.Skip();
	}

	virtual void OnStyleColorChanged(wxColourPickerEvent& event)
	{
		event.Skip();
	}
...
public:
	...
	SettingsFontsPanel(
		...
		wxWindowID id = wxID_ANY,
		const wxPoint& pos = wxDefaultPosition,
		const wxSize& size = wxSize(476, 363),
...
protected:
	...
	virtual void OnCargo(wxCommandEvent& event)
	{
		event.Skip();
	}

	virtual void OnRustc(wxCommandEvent& event)
	{
		event.Skip();
	}

	virtual void OnRacer(wxCommandEvent& event)
	{
		event.Skip();
	}

	virtual void OnProtoc(wxCommandEvent& event)
	{
		event.Skip();
	}

	virtual void OnRustSrc(wxCommandEvent& event)
	{
		event.Skip();
	}
...
public:
	...
	SettingsEnviromentPanel(
		...
		wxWindowID id = wxID_ANY,
		const wxPoint& pos = wxDefaultPosition,
		const wxSize& size = wxSize(500, 360),
		long style = wxTAB_TRAVERSAL
	);
	~SettingsEnviromentPanel();
};
...
protected:
	...
	// Virtual event handlers, overide them in your derived class
	virtual void OnIndicatorListChanged(wxCommandEvent& event)
	{
		event.Skip();
	}

	virtual void OnIndicatorCombobox(wxCommandEvent& event)
	{
		event.Skip();
	}

	virtual void OnIndicatorColor(wxColourPickerEvent& event)
	{
		event.Skip();
	}

	virtual void OnIndicatorCheckbox(wxCommandEvent& event)
	{
		event.Skip();
	}
	...
	virtual void OnIndicatorText(wxCommandEvent& event)
	{
		event.Skip();
	}
...
protected:
	...
	// Virtual event handlers, overide them in your derived class
	virtual void OnMarkerListChanged(wxCommandEvent& event)
	{
		event.Skip();
	}

	virtual void OnMarkerComboChanged(wxCommandEvent& event)
	{
		event.Skip();
	}

	virtual void OnMarkerColorChanged(wxColourPickerEvent& event)
	{
		event.Skip();
	}

	virtual void OnMarkerComboChanged(wxColourPickerEvent& event)
	{
		event.Skip();
	}
...
protected:
	...
	// Virtual event handlers, overide them in your derived class
	virtual void OnCheckboxChanged(wxCommandEvent& event)
	{
		event.Skip();
	}

	virtual void OnComboboxChanged(wxCommandEvent& event)
	{
		event.Skip();
	}
	...
	virtual void OnColorChanged(wxColourPickerEvent& event)
	{
		event.Skip();
	}
...
public:
	...
	SettingsEditorPanel(
		...
		wxWindowID id = wxID_ANY,
		const wxPoint& pos = wxDefaultPosition,
		const wxSize& size = wxSize(460, 411),
		long style = wxTAB_TRAVERSAL
	);
	~SettingsEditorPanel();
};
...
protected:
	...
	// Virtual event handlers, overide them in your derived class
	virtual void OnWindowColorChange(wxColourPickerEvent& event)
	{
		event.Skip();
	}

	virtual void OnWindowComboChange(wxCommandEvent& event)
	{
		event.Skip();
	}
	...
	virtual void OnWindowText(wxCommandEvent& event)
	{
		event.Skip();
	}

	virtual void OnWindowCheck(wxCommandEvent& event)
	{
		event.Skip();
	}
...
public:
	...
	SettingsWindowPanel(
		...
		wxWindowID id = wxID_ANY,
		const wxPoint& pos = wxDefaultPosition,
		const wxSize& size = wxSize(486, 554),
		long style = wxTAB_TRAVERSAL
	);
	~SettingsWindowPanel();
};
...
protected:
	...
	// Virtual event handlers, overide them in your derived class
	virtual void OnThemeApplySelected(wxCommandEvent& event)
	{
		event.Skip();
	}

	virtual void OnThemeImport(wxCommandEvent& event)
	{
		event.Skip();
	}

	virtual void OnThemeExportSelected(wxCommandEvent& event)
	{
		event.Skip();
	}
