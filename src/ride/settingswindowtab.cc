...
void SettingsWindowTab::WindowToGui(bool togui)
{
	...
	DIALOG_DATAX(fonts_and_colors, dock_active_caption, uiWindowDockActiveCaption);
	DIALOG_DATAX(fonts_and_colors, dock_active_caption_gradient, uiWindowDockActiveGradient);
	DIALOG_DATAX(fonts_and_colors, dock_inactive_caption, uiWindowDockInactiveCaption);
	DIALOG_DATAX(fonts_and_colors, dock_inactive_caption_gradient, uiWindowDockInactiveGradient);
	DIALOG_DATAX(fonts_and_colors, dock_active_caption_text, uiWindowDockActiveText);
	DIALOG_DATAX(fonts_and_colors, dock_inactive_caption_text, uiWindowDockInactiveText);
	...
	DIALOG_DATAX(fonts_and_colors, tab_inactive_border, uiWindowTabInactiveBorder);
	...
	DIALOG_DATAX(fonts_and_colors, statusbar_highlight, uiWindowStatusbarHighlight);
	DIALOG_DATAX(fonts_and_colors, statusbar_foreground, uiWindowStatusbarForeground);
	DIALOG_DATAX(fonts_and_colors, statusbar_background, uiWindowStatusbarBackground);
  ...
  */
	...
	DIALOG_DATA(current_settings_, switcher_row_count, uiSwitcherItemsPerRow, _I32);
	DIALOG_DATA(current_settings_, switcher_item_maxwidth, uiSwitcherItemMaxWidth, _I32);
	DIALOG_DATA(current_settings_, switcher_item_maxheight, uiSwitcherItemMaxHeight, _I32);
	DIALOG_DATA(current_settings_, switcher_text_margin_x, uiSwitcherTextMarginX, _I32);
	DIALOG_DATA(current_settings_, switcher_text_margin_y, uiSwitcherTextMarginY, _I32);
	...
	DIALOG_DATA(current_settings_, switcher_row_spacing, uiSwitcherRowSpacing, _I32);
	DIALOG_DATA(current_settings_, switcher_col_spacing, uiSwitcherColSpacing, _I32);
	DIALOG_DATA(current_settings_, switcher_dlg_main_border, uiSwitcherMainBorder, _I32);
	DIALOG_DATA(current_settings_, switcher_dlg_item_border, uiSwitcherItemBorder, _I32);
	DIALOG_DATA(current_settings_, switcher_min_width, uiSwitcherMinWidth, _I32);
	DIALOG_DATA(current_settings_, switcher_min_height, uiSwitcherMinHeight, _I32);

	DIALOG_DATAX(fonts_and_colors, switcher_background_color, uiSwitcherItemBackground);
	...
	DIALOG_DATAX(fonts_and_colors, switcher_selection_outline_color, uiSwitcherSelectionOutline);
