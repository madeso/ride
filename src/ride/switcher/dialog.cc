	...
	, style_(sstyle)
{
	...
	if (switcher_border_style_ == wxBORDER_NONE) switcher_border_style_ = wxBORDER_SIMPLE;
	...
	list_ctrl_->Create(
		this, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxWANTS_CHARS | wxNO_BORDER
	);
	...
	path_ctrl_ = new wxStaticText(
		this, wxID_ANY, "", wxDefaultPosition, wxDefaultSize, wxST_ELLIPSIZE_START
	);
...
void Dialog::OnCloseWindow(wxCloseEvent& WXUNUSED(event))
{  // NOLINT
...
void Dialog::OnSelectItem(wxCommandEvent& event)
{
	UpdateDescription();
}
