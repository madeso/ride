...
Item::Item(const wxString& title, const wxString& name, int id, const wxBitmap& bitmap)
	: title_(title)
	, name_(name)
	, id_(id)
	, bitmap_(bitmap)
...
const wxString& Item::title() const
{
	return title_;
}
...
const wxString& Item::name() const
{
	return name_;
}
...
const wxString& Item::description() const
{
	return description_;
}
...
const wxBitmap& Item::bitmap() const
{
	return bitmap_;
}
